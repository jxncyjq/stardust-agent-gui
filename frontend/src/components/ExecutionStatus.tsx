 ...
 * while a task is in flight: a blinking sparkle, the wall-clock seconds elapsed
...
export function ExecutionStatus({ elapsedSec, totalTokens = 0 }: Props) {
  return (
    <div className="flex items-center gap-1.5 px-1 pb-1.5 text-xs text-muted-foreground" role="status" aria-live="polite">
      <SparkleIcon className="legion-blink w-3.5 h-3.5 text-primary" />
